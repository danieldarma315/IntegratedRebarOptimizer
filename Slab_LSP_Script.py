...
# File path
file_path = r"C:\Users\Daniel\OneDrive\Desktop/Slab LSP case2.xlsx"
...
wall_width_left = sheet2['Wall width at the left end']
wall_width_right = sheet2['Wall width at the right end']
...
for i in range(len(sections)):
    total_length = (
        ...
        - ((wall_width_left[i] + wall_width_right[i]) / 2)
    )
...
for i, section in enumerate(sections):
    ...
    sum_total_required_quantity += required_weight[i]
    sum_total_purchased_quantity += purchasable_weight[i]
...
summary_table.add_row([
    ...
    "-",
    "-",  
    round(sum_total_required_quantity, 2),
    round(sum_total_purchased_quantity, 2)
    ])

print("\nRebar Summary Table:")
print(summary_table)

output_file_summary = r"C:\Users\Daniel\OneDrive\Desktop/Rebar_Summary_Slab_LSP.xlsx"
...
summary_df.loc[len(summary_df)] = ["Total", "-", "-", round(sum_total_required_quantity, 2), round(sum_total_purchased_quantity, 2) ]
...
discontinuous_file = r"C:/Users/Daniel/OneDrive/Desktop/Discontinuous rebar_slab.xlsx"
...
output_file = r"C:/Users/Daniel/OneDrive/Desktop/Optimized_Cutting_Pattern_Slab.xlsx"
